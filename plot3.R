...
subMetering1 <- as.numeric(SubSet_Datafile$Sub_metering_1)
subMetering2 <- as.numeric(SubSet_Datafile$Sub_metering_2)
subMetering3 <- as.numeric(SubSet_Datafile$Sub_metering_3)

#Create plot and add labels and formatting
